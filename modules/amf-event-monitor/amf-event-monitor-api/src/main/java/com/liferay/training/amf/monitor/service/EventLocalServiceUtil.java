...
public class EventLocalServiceUtil {
	...
	*/
	public static void addEvent(long companyId, long groupId,
		...
		getService().addEvent(companyId, groupId, user, ipAddress, eventType);
	}
	...
	*/
	public static com.liferay.training.amf.monitor.model.Event fetchEventByUuidAndGroupId(
	...
	*/
	public static com.liferay.training.amf.monitor.model.Event getEventByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<com.liferay.training.amf.monitor.model.Event> getEventsByUuidAndCompanyId(
